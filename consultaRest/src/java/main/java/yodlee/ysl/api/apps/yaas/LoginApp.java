...
public class LoginApp {
    ...
    static ResourceBundle resourceBundle = ResourceBundle.getBundle("resources.config");
    public static final String  localURLVer1= resourceBundle.getString("yodlee.localURLVer1");
    ...
    static String userName = resourceBundle.getString("yodlee.userName");
    static String userPassword = resourceBundle.getString("yodlee.userPassword");
     static String registerParam = resourceBundle.getString("yodlee.registerParam");
