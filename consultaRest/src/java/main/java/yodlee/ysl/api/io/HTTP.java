...
public class HTTP 
{
	...
	public static String doPost(String url,String requestBody) throws IOException
	{
        ...
        public static boolean doPostUserPasswd(String url, Map<String,String> sessionTokens, String requestBody,boolean isEncodingNeeded) throws IOException
	{
		...
		System.out.println(fqcn + " :: " + mn + " : " + "Sending 'HTTP POST' request");
		System.out.println(fqcn + " :: " + mn + " : "+ "Response Code : " + responseCode);
                if(responseCode!=801 && responseCode!=401){
                    resultado=true;
                }else{
                    resultado=false;
                }
